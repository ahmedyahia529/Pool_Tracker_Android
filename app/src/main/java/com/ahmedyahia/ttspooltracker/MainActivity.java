...
public class MainActivity extends Activity {
    ...
    public class AndroidBridge {
        ...
        public void login(final String username, final String password) {
            ...
            executor.execute(() -> {
                try {
                    ...
                    String reportsJson = reports.toString();
        ...
        public void getLatestReport() {
            runOnUiThread(() -> webView.evaluateJavascript("showLoading()", null));
            executor.execute(() -> {
                try {
                    JSONArray reports = listReports();
        ...
        @JavascriptInterface
        public void getReportByDate(final String date) {
            runOnUiThread(() -> webView.evaluateJavascript("showLoading()", null));
            executor.execute(() -> {
                try {
                    String report = fetchReportByDate(date);
    ...
    private void deliverPendingReport() {
        ...
        if (quoted != null && webView.getUrl() != null && webView.getUrl().endsWith("dashboard.html")) {
            pendingReportJson = null;
            webView.evaluateJavascript("onReportLoaded(" + quoted + ")", null);
        }
    }
