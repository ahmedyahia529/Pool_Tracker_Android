...
- Android dashboard now uses the full desktop TTS Sentinel dashboard layout and data model.
- Added native report-day switching through the Google Drive bridge.
- Added dashboard parity for Smart Alerts, Hourly Escalation Heatmap, Cabinet Intelligence, IPTV details, peak windows, repeated customers, current tickets and High Group Tickets.
- Added clickable ticket-detail popups for Current Ticket Detail and High Group Tickets.
